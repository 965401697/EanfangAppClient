 ...
 */
public class UpdateNumberProgressBar extends View {
    ...
    public UpdateNumberProgressBar(Context context) {
        this(context, null);
    }

    public UpdateNumberProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UpdateNumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int textVisible = attributes.getInt(R.styleable.UpdateAppNumberProgressBar_progress_text_visibility_update, PROGRESS_TEXT_VISIBLE);
