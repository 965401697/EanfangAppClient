...
public class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseUtil.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseUtil.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseUtil.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = BaseUtil.getApp().getResources();
