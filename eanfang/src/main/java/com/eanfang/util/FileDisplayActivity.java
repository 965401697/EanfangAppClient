...
public class FileDisplayActivity extends BaseActivity implements TbsReaderView.ReaderCallback {
    ...
    private void initView() {
        ...
        setTitle("查看详情");
        getFileUrlByIntent();
        mTbsReaderView = new TbsReaderView(FileDisplayActivity.this, this);
    ...
    private File getLocalFile() {
        return new File(Environment.getExternalStorageDirectory() + "/RongCloud/Media/", mFileName);
    }
    ...
    private void startDownload() {
        ...
        try {
            ...
            DownloadManager.Request request = new DownloadManager.Request(
                    Uri.parse(fileUrl));
            // 下载路径
            request.setDestinationInExternalPublicDir("/RongCloud/Media/", mFileName);
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                Log.i("downloadUpdate: ", currentBytes + " " + totalBytes + " "
                        + status + " " + progress);
                if (DownloadManager.STATUS_SUCCESSFUL == status && tvDownload.getVisibility() == View.VISIBLE) {
                    tvDownload.setVisibility(View.GONE);
