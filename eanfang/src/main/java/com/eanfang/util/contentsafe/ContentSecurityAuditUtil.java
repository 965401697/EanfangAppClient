...
public class ContentSecurityAuditUtil {
        ...
        EanfangHttp.post(TOKEN_URL)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            SharePreferenceUtil.get().set(SP_SAVE_TIME_KEY, System.currentTimeMillis() / 1000 + bean.getExpires_in());
                            SharePreferenceUtil.get().set(SP_SAVE_TOKEN_KEY, bean.getAccess_token());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    public void toAuditing(String content, ContentAuditingListener listener) {
        ...
        long saveTime = SharePreferenceUtil.get().getLong(SP_SAVE_TIME_KEY, 0);
        String saveToken = SharePreferenceUtil.get().getString(SP_SAVE_TOKEN_KEY, null);
