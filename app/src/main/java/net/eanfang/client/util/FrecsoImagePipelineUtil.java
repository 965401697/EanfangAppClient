 ...
 *@desc
 */
public class FrecsoImagePipelineUtil {
    private static final int MAX_HEAP_SIZE = (int) Runtime.getRuntime().maxMemory();
    public static final int MAX_DISK_CACHE_SIZE = 40 * ByteConstants.MB;
    public static final int MAX_MEMORY_CACHE_SIZE = MAX_HEAP_SIZE / 4 > 50 * ByteConstants.MB ? 50 * ByteConstants.MB : MAX_HEAP_SIZE / 4;
