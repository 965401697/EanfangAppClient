...
public class AddTaskDetailAdapter extends BaseQuickAdapter<WorkTaskBean.DetailsBean, BaseViewHolder> {
    public AddTaskDetailAdapter(int layoutResId, List data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, WorkTaskBean.DetailsBean item) {
