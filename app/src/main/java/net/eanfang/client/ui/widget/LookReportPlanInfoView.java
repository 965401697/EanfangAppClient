...
public class LookReportPlanInfoView extends BaseDialog implements View.OnClickListener {
    ...
    public LookReportPlanInfoView(Activity context, boolean isfull, WorkReportInfoBean.BeanBean.DetailsBean detailBean) {
