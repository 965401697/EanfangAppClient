...
import net.eanfang.client.ui.model.LookFaPiaoBean;
import net.eanfang.client.ui.model.PuPiaoBean;
        ...
        btn_complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rb_pro.isChecked()) {
                    ...
                    Gson gson = new Gson();
                    json = gson.toJson(zhuanPiaoBean);
                }
