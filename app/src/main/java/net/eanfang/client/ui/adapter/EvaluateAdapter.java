 ...
 */
public class EvaluateAdapter extends BaseQuickAdapter<ReceivedEvaluateBean.AllBean, BaseViewHolder> {
    public EvaluateAdapter(int layoutResId, List data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ReceivedEvaluateBean.AllBean item) {
