...
//        aMap.setMyLocationEnabled(true);// 设置为true表示启动显
//        aMap.getUiSettings().setm
...
//                Intent intent = new Intent(EvaluateActivity.this, EvaluateDetailActivity.class);
//                startActivity(intent);
//                ToastUtil.get().showToast(SelectAddressActivity.this, position + "");
