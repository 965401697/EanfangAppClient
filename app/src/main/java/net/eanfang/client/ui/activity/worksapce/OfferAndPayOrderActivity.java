...
public class OfferAndPayOrderActivity extends BaseActivity {
    ...
    public final List<String> allmTitles = Config.getConfig().getConstBean().getQuoteOrderConstant().get(Constant.STATUS);
    ...
    private void initView() {
        ...
        for (String title : mTitles) {
            mFragments.add(OfferAndPayListFragment.getInstance(title));
        }
    ...
    private void initData(int page) {
        int status = Config.getConfig().getConstBean().getQuoteOrderConstant().get(Constant.STATUS).indexOf(currentFragment.getmTitle());
