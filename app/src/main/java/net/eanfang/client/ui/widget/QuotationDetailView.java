...
public class QuotationDetailView extends BaseDialog {
    ...
    private void initView() {
        ...
        tvBusinessType.setText(Config.getConfig().getBusinessName(quoteDevicesBean.getModelCode()));
...
//        tvDeviceName.setText(Config.getConfig().getBusinessName(quoteDevicesBean.getModelCode()));
        tvUnit.setText(Config.getConfig().getConstBean().getDeviceConstant().get(Constant.UNIT).get(quoteDevicesBean.getUnit()));
