 ...
 */
public class WorkTransferDetailFinishWorkAdapter extends BaseQuickAdapter<WorkTransferDetailBean.FinishWorkEntityListBean, BaseViewHolder> {
    private boolean mIsDetail = false;

    public WorkTransferDetailFinishWorkAdapter(boolean isDetail) {
        super(R.layout.layout_work_transfer_detail_item);
        this.mIsDetail = isDetail;
    }

    @Override
    protected void convert(BaseViewHolder helper, WorkTransferDetailBean.FinishWorkEntityListBean item) {
