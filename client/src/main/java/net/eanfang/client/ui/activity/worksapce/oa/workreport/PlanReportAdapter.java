...
public class PlanReportAdapter extends BaseMultiItemQuickAdapter<WorkAddReportBean.WorkReportDetailsBean, BaseViewHolder> {
    ...
    public PlanReportAdapter(List<WorkAddReportBean.WorkReportDetailsBean> data, Context context) {
        super(data);
        this.mComtext = context;
        addItemType(WorkAddReportBean.WorkReportDetailsBean.FOLD, R.layout.item_template_plan_report_normal);
        addItemType(WorkAddReportBean.WorkReportDetailsBean.EXPAND, R.layout.item_template_plan_report_show);
    }
