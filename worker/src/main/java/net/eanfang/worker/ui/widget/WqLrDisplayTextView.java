 ...
 * @author WQ 2019 4/8
 */
public class WqLrDisplayTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public WqLrDisplayTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WqLrDisplayTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        // 获取自定义属性的值
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.WqLrDisplayTextView, defStyleAttr, 0);
        mLeftText = a.getString(R.styleable.WqLrDisplayTextView_left_text);
        mLeftTextColor = a.getColor(R.styleable.WqLrDisplayTextView_left_color, Color.BLACK);
        mLeftTextSize = a.getDimension(R.styleable.WqLrDisplayTextView_left_size, 45);
        mRightText = a.getString(R.styleable.WqLrDisplayTextView_right_text);
        mRightTextColor = a.getColor(R.styleable.WqLrDisplayTextView_right_color, Color.BLACK);
        mRightTextSize = a.getDimension(R.styleable.WqLrDisplayTextView_right_size, 45);
        // 回收
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        setScrollBarStyle(Typeface.BOLD);
