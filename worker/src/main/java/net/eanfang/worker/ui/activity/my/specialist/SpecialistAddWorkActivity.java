...
public class SpecialistAddWorkActivity extends BaseActivityWithTakePhoto {
            ...
            public void onOssSuccess() {
                runOnUiThread(() -> {
                    ...
                    EanfangHttp.post(url)
                            ...
                            .execute(new EanfangCallback<JSONObject>(SpecialistAddWorkActivity.this, true, JSONObject.class, (bean) -> {
                                setResult(RESULT_OK);
                                finish();
                            }));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ll_date:
                ...
                new DoubleDatePickerDialog(SpecialistAddWorkActivity.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
