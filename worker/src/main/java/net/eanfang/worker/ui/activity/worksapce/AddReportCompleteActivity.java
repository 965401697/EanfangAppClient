...
//        }
    ...
    private void inputVoice(EditText editText) {
        PermissionUtils.get(this).getVoicePermission(() -> {
            RecognitionManager.getSingleton().startRecognitionWithDialog(AddReportCompleteActivity.this, new RecognitionManager.onRecognitionListen() {
                @Override
    ...
    @OnClick({R.id.iv_content_voice, R.id.iv_question_voice, R.id.iv_reason_voice, R.id.iv_handle_voice, R.id.tv_add_team})
