...
public class PutUpSelectWorkerActivity extends BaseWorkerActivity {
    ...
    private void initData() {
        ...
        queryEntry.getIsIn().put("bizIds", Arrays.asList(Config.get().getBaseIdByCode("2.1", 1, Constant.BIZ_TYPE) + ""));//wq++
//        queryEntry.getIsIn().put("businessId", businessId);//wq--
        queryEntry.getIsIn().put("sysIds", businessId);//wq++
