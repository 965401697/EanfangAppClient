...
public interface EanfangConst {
     ...
     * 工作检查 未通过 待处理
     */
    public static final int WORK_INSPECT_STATUS_FAIL = 2;
    public static final String WORK_INSPECT_STATUS_FAIL_STR = "已拒绝";
    /**
     * 工作检查 处理完成
     */
    public static final int WORK_INSPECT_STATUS_FINISH = 3;
    ...
    public static final String WX_SECRET_CLIENT = "367df9bffcfc33d64c50860012ee2b37";

    //微信支付 appid 技师端
    public static final String WX_APPID_WORKER = "wx5e7969853addd542";
    public static final String WX_SECRET_WORKER = "584a16f5561e6506fe7dc454eb9ade78";
