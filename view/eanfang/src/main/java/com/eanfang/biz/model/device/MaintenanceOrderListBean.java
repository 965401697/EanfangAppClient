package com.eanfang.biz.model.device;
...
public class MaintenanceOrderListBean {
    ...
    private List<ShopMaintenanceOrderEntity> list;
    ...
    public List<ShopMaintenanceOrderEntity> getList() {
        return list;
    }

    public void setList(List<ShopMaintenanceOrderEntity> list) {
        this.list = list;
    }
}
