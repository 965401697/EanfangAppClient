...
import com.photopicker.com.util.BGABrowserPhotoViewAttacher;
import com.photopicker.com.util.BGAPhotoPickerUtil;
import com.photopicker.com.widget.BGAImageView;
...
public class BGAPhotoPageAdapter extends PagerAdapter {
    ...
    public View instantiateItem(ViewGroup container, int position) {
        ...
        BGAImage.display(imageView, R.drawable.bga_pp_ic_holder_dark, mPreviewImages.get(position), BGAPhotoPickerUtil.getScreenWidth(), BGAPhotoPickerUtil.getScreenHeight());
