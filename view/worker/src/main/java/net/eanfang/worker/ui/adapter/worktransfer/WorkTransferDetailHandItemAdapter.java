 ...
 */
public class WorkTransferDetailHandItemAdapter extends BaseQuickAdapter<WorkTransferDetailBean.ChangeGoodEntityListBean, BaseViewHolder> {
    private boolean mIsDetail = false;

    public WorkTransferDetailHandItemAdapter(boolean isDetail) {
        super(R.layout.layout_work_transfer_detail_item);
        this.mIsDetail = isDetail;
    }

    @Override
    protected void convert(BaseViewHolder helper, WorkTransferDetailBean.ChangeGoodEntityListBean item) {
