...
public class SpecialistIdentityCardCertification extends BaseActivityWithTakePhoto {
    ...
    private void fillData() {
        ivIdCardFront.setImageURI(com.eanfang.BuildConfig.OSS_SERVER + mExpertsCertificationEntity.getIdCardFront());
        ivIdCardBack.setImageURI(com.eanfang.BuildConfig.OSS_SERVER + mExpertsCertificationEntity.getIdCardSide());
        ivIdCardInHand.setImageURI(com.eanfang.BuildConfig.OSS_SERVER + mExpertsCertificationEntity.getIdCardHand());
    }
