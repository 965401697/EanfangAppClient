...
public class WorKReportDetailAdapter extends BaseMultiItemQuickAdapter<WorkReportInfoBean.WorkReportDetailsBean, BaseViewHolder> {
    ...
    public WorKReportDetailAdapter(List<WorkReportInfoBean.WorkReportDetailsBean> data, Activity activity) {
        super(data);
        this.mActivity = activity;
        addItemType(WorkAddReportBean.WorkReportDetailsBean.FOLD, R.layout.item_template_work_report_detail_normal);
        addItemType(WorkAddReportBean.WorkReportDetailsBean.EXPAND, R.layout.item_template_work_report_detail_show);
    }

    @Override
    protected void convert(BaseViewHolder helper, WorkReportInfoBean.WorkReportDetailsBean item) {
        if (helper.getItemViewType() == WorkAddReportBean.WorkReportDetailsBean.FOLD) {
