 ...
 * @author guanluocang
 * @data 2019/1/24
 * @description 首页今日待办 指示器
 */

public class HomeWaitIndicator extends View {
    private int number;
    ...
    public HomeWaitIndicator(Context context) {
        this(context,null);
    }

    public HomeWaitIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
