...
public class LoadingTextView extends FrameLayout {
    ...
    public LoadingTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LoadingText, defStyle,
                R.style.LoadingTextView);
        int style = a.getInt(R.styleable.LoadingText_textStyle, LinearLayout.VERTICAL);
        int gravity = a.getInt(R.styleable.LoadingText_textGravity, Gravity.CENTER);
        ColorStateList textColor = a.getColorStateList(R.styleable.LoadingText_textColor);
        int textSize = a.getDimensionPixelOffset(R.styleable.LoadingText_textSize, 15);
        mTextPadding = a.getDimensionPixelOffset(R.styleable.LoadingText_textPadding, 0);
        CharSequence text = a.getText(R.styleable.LoadingText_android_text);
        a.recycle();
